...
const AddReply = ({ form, submitted }) => {
  ...
  return (
    <div>
      <FormField field={form?.model?.firstName} submitted={submitted} />
      <FormField field={form?.model?.middleName} submitted={submitted} />
      <FormField field={form?.model?.lastName} submitted={submitted} />
      <FormField field={form?.model?.address} submitted={submitted} />
      ...
      {form.model.phones.childFields.map?.((phone, index) => {
        ...
        <React.Fragment>
          ...
          <FormField key={`${phone.model.number.key}${index}`} field={phone.model.number} submitted={submitted} />
          <FormField key={`${phone.model.number.type}${index}`} field={phone.model.type} submitted={submitted} />
        </React.Fragment>
        )})}
    </div>
  );
